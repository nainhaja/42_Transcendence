...
const fakeDataa = [
  { img: collection, title: "Abstrac Girl", link: "/game/1", mode: 1 },
  { img: collection2, title: "Beautiful Flower", link: "/game/2", mode: 2 },
  { img: collection3, title: "Abstrac Color", link: "/game/3", mode: 3},
];
