...
const TwoFactor: FC<Props> = ({ isOpen, setIsOpen, contentLabel, setTwoFactor }) => {
  ...
  // axios.get('http://localhost:5000/auth/login/2fa/enable', {withCredentials: true})
  // .then((res)=>
  // {
  ...
  useEffect(() => {
    // if (isOpen) {
    //   axios.get("http://localhost:5000/auth/login/2fa/enable", { withCredentials: true }).then((res) => {
